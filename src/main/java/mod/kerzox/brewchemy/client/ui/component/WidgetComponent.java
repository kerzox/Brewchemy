...
public abstract class WidgetComponent implements Renderable, GuiEventListener, NarratableEntry {
    ...
    public WidgetComponent(ICustomScreen screen, int x, int y, int width, int height, Component message) {
        this.screen = screen;
        this.x = x;
        this.y = y;
        this.width = width;
