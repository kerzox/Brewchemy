...
public class BrewingRecipe extends AbstractRecipe<RecipeInventory> {
    ...
    public BrewingRecipe(RecipeType<?> type, ResourceLocation id, String group, ItemStack result, SizeSpecificIngredient ingredient, int duration) {
    ...
    public static class Serializer implements RecipeSerializer<BrewingRecipe> {
        ...
        public BrewingRecipe fromJson(ResourceLocation pRecipeId, JsonObject json) {
            ...
            return new BrewingRecipe(BrewchemyRegistry.Recipes.BREWING_RECIPE.get(), pRecipeId, group, resultStack, ingredients[0], duration);
        }
